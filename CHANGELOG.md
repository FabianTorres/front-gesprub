...
### Changed
-   Se cambia la forma de insertar masivamente la carga de vectores


## [2.4.2] - 2026-05-14

### Added
-   Se agrega carga y actualizacion masiva de catalogo de vectores y anadir busqueda al historial

## [2.4.0] - 2026-04-06

### Added
-   Se agrega una forma de cargar pruebas masivamente

## [2.3.5] - 2026-04-06

### Added
-   Se agrega una forma de asignar una contraseña temporal en caso de olvido de contraseñas
...
### Fixed
-   Se soluciona problema que impedia subir archivo en algunas ocasiones.
...
### Fixed (Hotfix)
-   Se corrige problema que dejaba con un campo erroneo la carga de vectores.
